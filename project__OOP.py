...
class Stock_Data:
    ...
    def get_stock_data(self):
        ...
        filename= "Data/"+self.symbol+ "_Stock_Data.csv"
        # print(filename)
...
class Stock_Predict:
    ...
    def prophet_model(self):
        ...
        with open('Data/futurepredictions.csv', 'w', encoding="ISO-8859-1", newline='') as myfile:
        ...
        self.prediction_data =  pd.read_csv('Data/futurepredictions.csv')
